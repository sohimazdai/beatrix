...
export default function translate() {
  ...
  i18n.translations.en = {
    ...
    export_data_creating: 'Creating export',
    export_data_create_xlsx: 'Create xlsx file',
    export_data_date_period: 'Period',
    export_data_date_from: 'From',
    export_data_date_to: 'To',
    export_titles_date: 'Date',
    export_titles_time: 'Time',
    export_titles_glucose: 'Glucose (%type%)',
    exports_titles_breadUnits: '%type% %weight_if_bu%',
    exports_titles_insulin: 'Rapid insulin',
    exports_titles_longInsulin: 'Long insulin',
    exports_titles_comment: 'Comment',
    export_data_titles_statistics_name: "Name",
    export_data_titles_statistics_name_value: "Value",
    export_data_titles_average_glucose: 'Average daily glucose (%type%)',
    export_data_titles_average_breadUnits: 'Average daily carbs. %type% %weight_if_bu%',
    export_data_titles_average_insulin: 'Average daily short insulin',
    export_data_titles_average_long_insulin: 'Average daily long insulin',
    export_data_titles_average_total_notes: 'Total notes in report',
    export_data_titles_average_date_from: 'Report start date',
    export_data_titles_average_date_to: 'Report end date',
  };
  ...
  i18n.translations.es = {
    ...
    // DASHBOARD
    compensation: 'Сompensación',
    last_notes: 'Ultimas notas',
    no_recent_notes_today: 'No hay registros para hoy',
    glucose_chart: 'Gráfico de glucosa',
    rest_active_insulin: 'Insulina activa',
    expires_in: 'Expira en',
    minutes_short: 'min',
    hours_short: 'h',
    statistics_today: 'Hoy',
    statistics_yesterday: 'Ayer',
    statistics_last_month: 'El mes pasado',
    statistics_last_three_month: 'Últimos tres meses',

    breadUnits_long: 'Racion de HC',
    carbohydrates_long: 'Carbohidratos',
    one_bread_unit_contents: ' 1 Racion de HC contiene %number% gramos de carbohidratos.',

    hypoglycemia_count: 'Hipoglucemia',
    hyperglycemia_count: 'Hiperglucemia',
    normalglycemia_count: 'Norma',

    glucose_icon_tooltip: 'Glucosa en sangre.Se mide en %measure%.\nGlucemia objetivo indicada como %target% %measure%.\nNorma que va desde %min% hasta %max%.',
    breadunits_icon_tooltip: '%type%.\n%for_bu%',
    note_date_and_time: 'Tiempo de creación de nota',
    short_insulin_icon_tooltip: 'Insulina de acción ultrarapida',
    long_insulin_icon_tooltip: 'Insulina de acción prolongada',

    your_hba1c: 'HbA1c',
    glycated_hemoglobin: 'Hemoglobina glicada',
    calculated_days: 'Cantidad de dias',
    calculate: 'Calcular',
    too_little_data_for_advanced_analys: 'Muy pocos datos para un análisis preciso.',
    glucose_not_found_for_diagram: 'No hay datos de glucosa disponibles para mostrar el gráfico',
  }
  /* ES */
  ...
  i18n.translations.ru = {
    ...
    export_data_creating: 'Создание экспорта',
    export_data_create_xlsx: 'Создать файл',
    export_data_date_period: 'Период',
    export_data_date_from: 'С',
    export_data_date_to: 'До',
    export_titles_date: 'Дата',
    export_titles_time: 'Время',
    export_titles_glucose: 'Глюкоза (%type%)',
    exports_titles_breadUnits: '%type% %weight_if_bu%',
    exports_titles_insulin: 'Инсулин',
    exports_titles_longInsulin: 'Пролонгированный инсулин',
    exports_titles_comment: 'Комментарий',
    export_data_titles_statistics_name: "Название",
    export_data_titles_statistics_name_value: "Значение",
    export_data_titles_average_glucose: 'Средняя глюкоза (%type%)',
    export_data_titles_average_breadUnits: 'Среднесуточные углеводы. %type% %weight_if_bu%',
    export_data_titles_average_insulin: 'Среднесуточный короткий инслуин',
    export_data_titles_average_long_insulin: 'Среднесуточный пролонгированный инсулин',
    export_data_titles_average_total_notes: 'Всего заметок',
    export_data_titles_average_date_from: 'Дата начала отчета',
    export_data_titles_average_date_to: 'Дата окончания отчета',
  }
  /* 🇷🇺 */
}
